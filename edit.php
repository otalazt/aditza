...
echo '<div class="opziottipi"><label>Euskalkia : </label><input name="Euskalkia" list="Euskalkia"';
		if(isset($Euskalkia)){echo ' value="'.$Euskalkia.'" ';}
		echo'><datalist id="Euskalkia">';
		while($resultatEuskalkia = mysql_fetch_object($sqlEuskalkia)){echo '<option value="'.$resultatEuskalkia->Euskalkia.'">';}
		echo '</datalist></div> ';

echo '<div class="opziottipi"><label>Aditza : </label><input name="Aditza" list="Aditza"';
		if(isset($Aditza)){echo ' value="'.$Aditza.'" ';}
		echo'><datalist id="Aditza">';
		echo '<option value="Aditz laguntzailea">';
		echo '<option value="Aditz trinkoak">';
		while($resultatAditza = mysql_fetch_object($sqlAditza)){echo '<option value="'.$resultatAditza->Aditza.'">';}
		echo '</datalist></div> ';

echo '<div class="opziottipi"><label>Modua : </label><input name="Modua" list="Modua"';
		if(isset($Modua)){echo ' value="'.$Modua.'" ';}
		echo'><datalist id="Modua">';
		while($resultatModua = mysql_fetch_object($sqlModua)){echo '<option value="'.$resultatModua->Modua.'">';}
		echo '</datalist></div> ';

echo '<div class="opziottipi"><label>Aldia : </label><input name="Aldia" list="Aldia"';
		if(isset($Aldia)){echo ' value="'.$Aldia.'" ';}
		echo'><datalist id="Aldia">';
		while($resultatAldia = mysql_fetch_object($sqlAldia)){echo '<option value="'.$resultatAldia->Aldia.'">';}
		echo '</datalist></div> ';

echo '<div class="opziottipi"><label>Forma : </label><input name="Forma" list="Forma"';
		if(isset($Forma)){echo ' value="'.$Forma.'" ';}
		echo'><datalist id="Forma">';
		while($resultatForma = mysql_fetch_object($sqlForma)){echo '<option value="'.$resultatForma->Forma.'">';}
		echo '</datalist></div> ';

echo '<div class="opziottipi"><label>Nor : </label><input name="Nor" list="Nor"';
		if(isset($Nor)){echo ' value="'.$Nor.'" ';}
		echo'><datalist id="Nor">';
		while($resultatNor = mysql_fetch_object($sqlNor)){echo '<option value="'.$resultatNor->Nor.'">';}
		echo '</datalist></div> ';

echo '<div class="opziottipi"><label>Nori : </label><input name="Nori" list="Nori"';
		if(isset($Nori)){echo ' value="'.$Nori.'" ';}
		echo'><datalist id="Nori">';
		while($resultatNori = mysql_fetch_object($sqlNori)){echo '<option value="'.$resultatNori->Nori.'">';}
		echo '</datalist></div> ';

echo '<div class="opziottipi"><label>Nork : </label><input name="Nork" list="Nork"';
		if(isset($Nork)){echo ' value="'.$Nork.'" ';}
		echo'><datalist id="Nork">';
		while($resultatNork = mysql_fetch_object($sqlNork)){echo '<option value="'.$resultatNork->Nork.'">';}
		echo '</datalist></div> ';
...
<tr id="<?php echo $id; ?>" class="edit_tr <?php echo $Euskalkia; ?>">
	...
	<span class="text spannagusia toka">
		<span class="textLeg">toka:</span><span id="toka_<?php echo $id; ?>" class="text textToka <?php echo $Toka; ?>"><?php if(!empty($Toka)){echo $Toka;} ?></span></span>
		<input type="text" value="<?php echo $Toka; ?>" class="editbox" id="toka_input_<?php echo $id; ?>" />
	<span class="text spannagusia noka">
		<span class="textLeg">noka:</span><span id="noka_<?php echo $id; ?>" class="text textNoka <?php echo $Noka; ?>"><?php if(!empty($Noka)){echo $Noka;} ?></span></span>
		<input type="text" value="<?php echo $Noka; ?>" class="editbox" id="noka_input_<?php echo $id; ?>" />
		<span class="textLeg">xuka:</span><span id="xuka_<?php echo $id; ?>" class="text textXuka <?php echo $Xuka; ?>"><?php if(!empty($Xuka)){echo $Xuka;}?></span></span>
		<input type="text" value="<?php echo $Xuka; ?>" class="editbox" id="xuka_input_<?php echo $id; ?>" />
		<span class="textLeg">zuka:</span><span id="zuka_<?php echo $id; ?>" class="text textZuka <?php echo $Zuka; ?>"><?php if(!empty($Zuka)){echo $Zuka;}?></span></span>
